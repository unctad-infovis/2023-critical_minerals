...
const containerFigure1 = document.getElementById('app-root-2023-critical_minerals_figure1');
if (containerFigure1) {
  const rootFigure1 = createRoot(containerFigure1);
  rootFigure1.render(<Figure1 />);
}

const containerFigure2 = document.getElementById('app-root-2023-critical_minerals_figure2');
if (containerFigure2) {
